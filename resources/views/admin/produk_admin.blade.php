...
@section('konten-admin')
    ...
    <div class="content-wrapper">
        ...
        <button type="button" class="btn btn-success" style="margin-left: 15px; margin-bottom:20px;" data-toggle="modal"
            data-target="#cek_nama_produk">
            Cari sesuai nama
        </button>

        <!-- Modal -->
        <div class="modal fade" id="cek_nama_produk" tabindex="-1" role="dialog"
            aria-labelledby="cek_nama_produkLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="cek_nama_produkLabel">Cari Data</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form action="/produk-adm/cariProduk" method="get">
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <tbody>
                                        @foreach ($produk as $key => $item)
                                            <tr>
                                                ...
                                                <td><img src="{{asset('storage/images/' . $item->foto)}}" alt=""
                                                ...
                                                <td>
                                                    <form action="/ubah-status-produk" method="post">
                                                        @csrf
                                                        @method('put')
                                                        ...
                                                        <select name="status"
                                                            ...
                                                            <option value="tersedia"
                                                                @if ($item->status_produk == 'tersedia') selected @endif>tersedia
                                                            </option>
                                                            <option value="tidak tersedia"
                                                                @if ($item->status_produk == 'tidak tersedia') selected @endif>tidak
                                                                tersedia</option>
                                                        </select>
                                                    </form>
                                                </td>
                                                <td>
                                                    ...
                                                    <div class="modal fade" id="dataproduk{{ $item->id }}"
                                                        ...
                                                        aria-hidden="true">
                                                        <form action="/produk-adm/{{ $item->id }}" method="post"
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="card-body">
                                                                            <div class="form-group">
                                                                                <label for="gambar_update">gambar
                                                                                    produk</label>
                                                                                <input type="hidden" class="form-control"
                                                                                    name="old_image"
                                                                                    value="{{ $item->foto }}">
                                                                                @if ($item->foto)
                                                                                    <img src="./storage/images/{{ $item->foto }}"
                                                                                        alt=""
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <textarea type="text" class="form-control" id="deskripsi_produk" name="deskripsi_produk"
                                                                                    placeholder="masukkan deskripsi produk">{{ $item->deskripsi }}</textarea>
                                                                            </div>
                                                                            <div class="form-group">
