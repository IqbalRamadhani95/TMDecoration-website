          ...
          <div class="col-4">
              <div class="card">
                  <div class="card-body text-center">
                    ...
                    <p style="margin-top: -10px;">{{ Auth::User()->alamat }}</p>
                    <a href="/"><button class="btn-profil"><i class="bi bi-skip-backward-fill"></i> Beranda</button></a>
                  </div>
              </div>
          </div>
          <div class="col-8">
                  ...
                  <div class="card-body">
                    ...
                    <form action="/profil-user/edit" method="post" enctype="multipart/form-data" class="row">
                        ...
                        <div class="col-md-6 mt-2">
                          ...
                          <input type="text" class="form-control" id="nomor" name="username" value="{{ Auth::User()->username }}">
                        </div>
                        <div class="col-md-6 mt-2">
                          <label for="waktu-mulai" class="form-label label-profil">No. Hp</label>
                          <input type="text" class="form-control" id="waktu-mulai" name="noHp" value="{{ Auth::User()->noHp }}">
                        </div>
                        <div class="col-md-6 mt-2">
                          <label for="waktu-selesai" class="form-label label-profil">Email</label>
                          <input type="text" class="form-control" id="waktu-selesai" name="email" value="{{ Auth::User()->email }}">
                        </div>
